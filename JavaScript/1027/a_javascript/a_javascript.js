...
! 자바스크립트 소개
    ...
    - html
        : 웹 콘텐츠를 구성하고 의미를 부여하는데 
            사용하는 마크업 언어
    - css
        : HTML 콘텐츠에 스타일을 적용하는데 
            사용하는 스타일 규칙 언어
    ...
    ! 자바스크립트의 활용
        1. 웹 클라이언트 애플리케이션 개발 (프론트엔드)
           사용자가 웹 요소를 제어하는 웹 사이크의 User Interface 부분에 활용 가능

            User Interface: 메뉴, 텍스트 팝업 등
                사용자가 사이트를 편리하게 사용할 수 있도록 하는 모든 디자인 요소
            
            웹 에플리케이션: 다양한 기능을 가진 웹 페이지
                ex. 별도의 설치 없이 웹 브라우저 만으로도 해당 애플리케이션 기능 사용 가능한 웹

        2. 웹 서버 애플이케이션 개발 (백엔드)
    ...
    ! 자바스크립트의 특징
        ...
        2. 객체 기반
            : 객체를 사용해서 데이터와 함수를 묶을 수 있는 언어
        3. 이벤트 기반
            : 이벤트 기반 프로그래밍을 지원
                사용자의 행동(클릭, 키보드입력, 마우스 이동 등)에 따라
                코드가 실행되는 방식
...
// 현재 웹 페이지에서 첫 번째 버튼 태그를 찾아서 저장
// 같다: ==
// 우항의 값을 좌항에 넣는다: =
const button = document.querySelector('button');

// .addEventListener 메소드를 사용하여
//  버튼 요소에 클릭 에빈트 리스너 추가

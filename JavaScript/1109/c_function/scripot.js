...
// : A->B->C 동작을 함수 ABC로 구현
// :  , 다른 위치(코드)에서 해당 절차 즉, ABC를 다시 사용 가능
// : 코드의 재사용성을 향상, 가독성 향상 그리고 디버깅을 용이하게 함.
...
console.log('---변수 초기화 하여 사용---');
console.log(result); // 6
console.log('---함수 바로 사용---');
...
//? 3. 이벤트 처리
// : 웹 페이지에서 발생하는 다양한 이벤트(버튼 클릭, 폼 제출 등)
// : , 처리하는데에 사용
...
// : , 해당 인수는 함수 내부로 전달되어 매개변수(paramerers)라는
// : , 이름으로 사용

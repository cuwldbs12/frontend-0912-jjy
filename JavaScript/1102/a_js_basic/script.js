...
//? 4-4. 웹 브라우저 화면에 출력
// : 브라우저 화면에서 결과값 확인하는 용도의 출력

// document(웹 문서)에서 괄호 안의 내용을 write(표시)하는 명령문
// 괄호 안에는 실제 웹 브라우저 화면에 표시할 내용(HTML 태그 사용 가능), 어떤 결과값이 저장된 함수도 삽입 가능
// document.write();

document.write('<h1>자바스크립트 출력</h1>');

// 사용자로 부터 입력받은 내용과 변수를 섞어서 나타낼 수 있음.
